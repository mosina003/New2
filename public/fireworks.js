...
var colours=new Array("#03f", "#f03", "#0e0", "#93f", "#0cf", "#f93", "#f0c", "#ff0", "#0ff", "#f0f"); 
...
function bang(N) {
  ...
  for (i=bits*N; i<bits+bits*N; i++) { 
    ...
    if (decay[i]==15) Z.fontSize="14px";
    else if (decay[i]==7) Z.fontSize="8px";
